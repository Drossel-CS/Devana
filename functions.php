<?php
/**
 * Devana functions and definitions
 *
...
if (!function_exists('devana_setup')):
    /**
     ...
     */
    function devana_setup()
{
        /*
         * Make theme available for translation.
         * Translations can be filed in the /languages/ directory.
         * If you're building a theme based on Devana, use a find and replace
         * to change 'devana' to the name of your theme in all the template files.
         */
        load_theme_textdomain('devana', get_template_directory() . '/languages');
        ...
        register_nav_menus(array(
            'menu-1' => esc_html__('Primary', 'devana'),
        ));
        ...
        add_theme_support('custom-background', apply_filters('devana_custom_background_args', array(
...
add_action('after_setup_theme', 'devana_setup');
 ...
 */
function devana_content_width()
{
    // This variable is intended to be overruled from themes.
    // Open WPCS issue: {@link https://github.com/WordPress-Coding-Standards/WordPress-Coding-Standards/issues/1043}.
    // phpcs:ignore WordPress.NamingConventions.PrefixAllGlobals.NonPrefixedVariableFound
    $GLOBALS['content_width'] = apply_filters('devana_content_width', 640);
}
add_action('after_setup_theme', 'devana_content_width', 0);
 ...
 */
function devana_widgets_init()
{
    register_sidebar(array(
        'name' => esc_html__('Sidebar', 'devana'),
        'id' => 'sidebar-1',
